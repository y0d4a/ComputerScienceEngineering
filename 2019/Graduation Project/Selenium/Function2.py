"""
    ...
    ※ 본 기능 2에는 노드의 ID가 입력되면 해당 노드 ID의 방문비율을 몽고 DB에서 가져와 결정 기준치 값 이상이면 'Blue'를, 미만이면 'Red'를 반환한다.
"""
...
class Function2:
    ...
    def is_blue_or_red_node(self, object_id):
...
f2 = Function2()
print(f2.is_blue_or_red_node("5d88f9eebf68e1e79161bac9"))